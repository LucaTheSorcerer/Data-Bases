...
CREATE TABLE EmployeeProjects(
    ...
    IsValidAssignment BIT, -- Added based on the alteration
...
CREATE TABLE Skills (
    ...
    SkillCategory NVARCHAR(50), -- Added based on the alteration
    SkillLevel NVARCHAR(20) -- Added based on the alteration
);
...
CREATE TABLE Notifications(
    ...
    Type NVARCHAR(50),
    isRead BIT, -- Added based on the alteration
    PriorityLevel NVARCHAR(50) -- Added based on the alteration
);
...
CREATE TABLE EmployeeTraining (
    ...
    TrainingStatus NVARCHAR(50), -- Added based on the alteration
    TrainingScore DECIMAL(5, 2), -- Added based on the alteration
    CompletionDate DATE -- Added based on the alteration
);
